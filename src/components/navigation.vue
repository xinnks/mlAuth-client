...
<template>
  <nav class="flex items-center justify-between flex-wrap bg-primary-300 p-6">
    ...
    <div class="flex justify-center space-x-4" v-if="session">
      ...
      <router-link to="/settings" title="Settings Page" class="text-sm p-2 leading-none border-2 rounded-full text-black border-black hover:border-transparent hover:text-primary hover:fill-primary hover:bg-black lg:mt-0">
      ...
      <button @click="logOut()" title="Log Out" class="text-sm p-2 leading-none border-2 rounded-full text-black border-black hover:border-transparent hover:text-primary hover:bg-black lg:mt-0">
